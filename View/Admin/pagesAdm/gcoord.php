...
$senha = "";
$botao = "Cadastrar";
$nomebotao = "cadastrarcoo";
$id = "";  
  if (isset($_GET['cooid'])) {
     $result = $professor->buscarcooid($_GET['cooid']);
     $vetor = mysqli_fetch_array($result);

     $nome = $vetor['coo_nome'];
     $cpf = $vetor['coo_cpf'];
     $telefone = $vetor['coo_telefone'];
     $email = $vetor['coo_email'];
     $senha = $vetor['coo_senha'];
     $botao = "Editar";
     $nomebotao = "editarcoo";
     $id = $_GET['cooid'];
  }
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav na1" style="font-family: 'Blinker', sans-serif!important;">
             ...
             <div class="col-12">
                ...
                <li class="nav-item">
                  <a  class="nav-link" href="gcoord.php" style = "font-size: 110%!important;">
...
<div  class="main-content">
  <div class="fundocolorx">
   <div class="text-center">
     <img class="img-fluid" src="../../frontend/img/gcoo1.png" width="70%">
   </div>
 </div>
        ...
        <div style="font-family: 'Teko', sans-serif;">
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input style="font-size: 180%;" type="text" name="nome" class="form-control" id="" placeholder="Ex:Emerson Pereira" required value="<?php echo $nome?>">

              <input type="hidden" name="cooid" value="<?php echo $id?>">
            </div>

            <div class="form-group col-md-6">
              <label style="font-size:200%;" for="inputDuracao">CPF:</label>
              <input style="font-size: 180%;" type="text" name="cpf" class="form-control" id="cpf" placeholder="000.000.000-00" required value="<?php echo $cpf?>">
            </div>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input style="font-size: 180%;"  type="email" name="email" class="form-control" id="inputEmail3" placeholder="emerson@gmail.com" required value="<?php echo $email?>">
            </div>
          ...
          <div class="form-group col-md-6">
            ...
            <select id="idesc" class="form-control" name="idescola">
        ...
        <div class="container">
            <div class="col-12">
              ...
              <div class="form-group ml-md-4 text-center">
                <input type="submit" style="font-size: 140%;" value="<?php echo $botao?>" name="<?php echo $nomebotao?>" class="btn btn-success py-3 px-4">
              </div>
              </div>
              <div class="col-6">
                <div class="form-group col-md-12 text-center">
                <a href="gcoord.php"><input style="font-size: 140%;" type="button" value="Limpar" class="btn btn-warning px-4"> </a>
              </div>
              </div>
            </div>
          </div>
    ...
    <div class="col-xl-12 order-xl-2">
     ...
     <form method="POST" id="form-pesquisa" action="#">
      <div style="font-family: 'Teko', sans-serif;">
        <div class="form-row">
          <div class="form-group col-md-6">
            <label style="font-size:200%;" for="inputEstado">Nome do Coordenador</label>
           ...
           <table class="table table-striped table-responsive">
            <thead>
              <tr>
                ...
                <th style="font-size:80%;" scope="col">Nome</th>
  ...
  $(function(){
    $("#pesquisa").keyup(function(){
      ...
      if (pesquisa != '') {
        ...
        $.post('../../../Controller/C_Buscarcoo.php', dados, function(retorna){
